...
const Footer = () => {
  ...
  return (
    <footer
      ...
      className="flex flex-wrap gap-5 justify-between py-6 mt-12 bg-white border-t border-black border-opacity-10 max-md:mt-6 max-md:px-4"
    ...
    >
      ...
      <div className="flex gap-4 justify-center items-center py-1.5 max-md:flex-col md:max-w-full lg:max-w-full">
        <div
          ...
          className="flex overflow-hidden text-center item-center py-1 my-auto w-full"
        >
          <Image
            loading="lazy"
            src={meelance_gradient}
            alt="Meelance logo"
            className="object-contain aspect-[4.56] w-[100px] ml-[3rem]"
          />
        </div>
        <div className="justify-center items-center py-1 my-auto lg:ml-auto ml-[-2.8rem] w-full">
          <p
            data-layername="2024MeelanceIncAllRightsReserved"
            className="my-auto text-sm font-medium leading-none text-black min-w-[250px] max-md:text-center w-full"
          >
